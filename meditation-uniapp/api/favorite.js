...
export const addFavorite = (targetId, targetType = 'track') => post('/meditation/favorite', { targetId, targetType }, false)
export const removeFavorite = (favoriteId) => del(`/meditation/favorite/${favoriteId}`, null, false)
